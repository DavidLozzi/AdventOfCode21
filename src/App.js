...
import Day14 from './14-extended-polymerization/day14'
...
function App() {
  ...
  return <div className="App">
    ...
    {!selectedDay && <div className="buttons-wrapper">
        ...
        one... two... skip a few
        <button onClick={() => setSelectedDay('day14')}>Day 14 - Extended Polymerization</button>
      </div>}
    </div>
 </div>
}
